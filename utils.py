...
class OpenAIModel:
    ...
    def generate(self, input_string, temperature = 0.0):
        ...
        elif self.model_name in ['gpt-4', 'gpt-3.5-turbo', 'qwen/qwen-2.5-coder-32b-instruct', "deepseek/deepseek-chat"]:
    ...
    def batch_generate(self, messages_list, temperature = 0.0):
        ...
        elif self.model_name in ['gpt-4','gpt-3.5-turbo','gpt-3.5-turbo-16k', 'qwen/qwen-2.5-coder-32b-instruct', "deepseek/deepseek-chat"]:
